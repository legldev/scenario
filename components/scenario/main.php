...
<!-- Add New Scenario -->
    ...
    <table class="adminlist" cellpadding="1">
		<thead><tr><th class="title">Agregar Escenarios</th></tr></thead>

    <tbody>

    <tr class="row1"><td align="center">Ingresa los datos principales del Escenario a crear.</td></tr>
    ...
    <tr align="center"><td><input type="submit" name="submit" class="button2" value="Siguiente"></td></tr>
...
<div id="section_icon"><div id="section_title">Escenarios</div></div></div>
...
<section>
    ...
    <li> <a href="<?php echo create_url('scenario');?>&mode=addnew" target="_self" title="Agregar Escenario">Agregar Escenario</a></li>
...
<h1><center>Ultimo Escenario Creado</center></h1>
   <section>
      <div class="clear-separator"></div><!-- Separador -->
<?php if(mysql_num_rows($sql_s)==0) { echo '<p>No hay escenarios creados</p>'; } else { ?>
