...
<!-- Add New Event -->
    ...
    <tr class="row0"><td>
        <label for="s_name">Nombre<b class="red">*</b></label>
        <input name="s_name" id="s_name" maxlength="50" size="40" onfocus="showHelp(this);" onblur="hideHelp(this);" type="text">
        <div id="s_name_text" class="info_box"><p>Ingresa el Nombre del Escenario (Ejemplo: "Teatro Municipal de Valencia").</p></div>
    </td></tr>
...
<li> <a href="<?php create_url('events');?>&mode=addnew" target="_self" title="Agregar Evento">Agregar Evento</a></li>
<li>              <a target="_self" title="Agregar Escenario" onclick="alert ('Opcion no Disponible');">Modificar Escenario</a>  </li>
<li>                  <a target="_self" title="Ver Lista de Escenarios" onclick="alert ('Opcion no Disponible');">Mostrar todos los Escenarios</a>     </li>
...
<div id="section_icon"><div id="section_title">Entradas</div></div></div>
...
<li> <a onclick="alert ('Opcion no Disponible');" target="_self" title="Agregar Evento">Agregar Nuevas Entradas a Vender</a></li>
<li>              <a target="_self" title="Agregar Escenario" onclick="alert ('Opcion no Disponible');">Modificar Configuración</a>  </li>
<li>                  <a target="_self" title="Ver Lista de Escenarios" onclick="alert ('Opcion no Disponible');">Mostrar todos las entradas en venta</a>     </li>
...
<article class="content">
    <h1><center>Estadisticas de Entradas Vendidas</center></h1>
   <section>
    <div class="clear-separator"></div><!-- Separador -->
